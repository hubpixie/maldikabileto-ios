//
//  CmyUnusedPrivateTicketDetailsViewController.swift
//  MaldikaBileto
//
//  Created by venus.janne on 2018/09/03.
//  Copyright © 2018 x.yang. All rights reserved.
//

import UIKit

class CmyUnusedPrivateTicketDetailsViewController: CmyViewController {
    ...
    override func viewDidLoad() {
        ...
        //QRコードイメージの読み込み
        if let ticketImage = self.ticket.ticketImage {
